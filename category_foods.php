...
<section class="food-search text-center">
    <div class="container">
        ...
        <h2>Foods on <a href="#" class="text-white" style="text-decoration: none;">" <?php echo $category_name; ?> "</a></h2>
...
<section class="food-menu" style="height: auto; margin-top: 20px;">
    <div class="container">
        ...
        <?php
        // get food based on category name
        $food_sql = "SELECT * FROM food WHERE product_category='$category_name'";
